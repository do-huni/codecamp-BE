...
let BoardsResolver = class BoardsResolver {
    constructor(boardsService, cacheManager) {
...
__decorate([
    (0, graphql_1.Query)(() => [board_entity_1.Board], { nullable: true }),
...
exports.BoardsResolver = BoardsResolver = __decorate([
    ...
    __metadata("design:paramtypes", [boards_service_1.BoardsService, Object])
], BoardsResolver);
